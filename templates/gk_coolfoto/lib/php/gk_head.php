...
<link href="<?php echo $template_baseurl; ?>/css/style<?php if($stylearea){ echo (isset($_COOKIE['gk27_style']) ? $_COOKIE['gk27_style'] : $template_color);} else {echo $template_color;} ?>.css" rel="stylesheet" media="all" type="text/css" />
