...
<?php if($news_amount > 0) : ?>
	...
	<div class="gk_npro_mainwrap<?php if($this->config['autoanim'] == TRUE) echo ' autoanim'; ?>" id="gk_npro-<?php echo $this->config['module_unique_id']; ?>" style="width: <?php echo $block_width; ?>;">
