window.addEvent("load",function(){	
	$$('.gk_npro_mainwrap').each(function(el,i){
		...
		if($E('.gk_npro_full_interface', main) && $E('.gk_npro_full_scroll1', main)){
			...
			var scroller_main = new Fx.Scroll($E('.gk_npro_full_scroll1', main),{duration: $G['animation_speed']});	
		...
		if($E('.gk_npro_short_interface', main)){
			var scroller_list = new Fx.Scroll($E('.gk_npro_short_scroll1', main),{duration: $G['animation_speed']});
