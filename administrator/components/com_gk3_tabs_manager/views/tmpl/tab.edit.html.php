			...
			<table class="adminlist">
				<tbody>
					...
					<tr id="form_content" <?php if($data[3] != 'xhtml')  echo ' style="display: none;"'; ?>>
						...
						<td>
							<?php if($wysiwyg == 0) : ?>
							<textarea id="content" name="content" rows="20" cols="50"><?php echo htmlspecialchars_decode($data[4]); ?></textarea>
							<?php else : ?>
							
							<?php
       							$editor =& JFactory::getEditor();
       							echo $editor->display('content', htmlspecialchars_decode($data[4]), '550', '400', '60', '20', true);
       						?>
